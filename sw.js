const CACHE="dawami-simple-v4-5";
const ASSETS=["./","./index.html","./simple.css?v=4.5","./core.js?v=4.5","./simple.js?v=4.5","./manifest.webmanifest?v=4.5","./icon.svg","./holidays-om.json"];
