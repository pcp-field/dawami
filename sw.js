const CACHE="dawami-v7-1";
const ASSETS=["./","./index.html","./dawami-v7.css?v=7.0","./core.js?v=7.0","./dawami-v7-1.js?v=7.1","./manifest.webmanifest?v=7.0","./icon.svg?v=7.0","./holidays-om.json"];
