const CACHE="dawami-simple-v5-1";
const ASSETS=["./","./index.html","./simple.css?v=5.1","./core.js?v=5.1","./simple.js?v=5.1","./manifest.webmanifest?v=5.1","./icon.svg","./holidays-om.json"];
