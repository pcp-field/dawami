const CACHE="dawami-simple-v4-6";
const ASSETS=["./","./index.html","./simple.css?v=4.6","./core.js?v=4.6","./simple.js?v=4.6","./manifest.webmanifest?v=4.6","./icon.svg","./holidays-om.json"];
