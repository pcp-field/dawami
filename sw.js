const CACHE="dawami-v8-0";
const ASSETS=["./","./index.html","./dawami-v8.css?v=8.0","./core.js?v=8.0","./dawami-v8.js?v=8.0","./manifest.webmanifest?v=8.0","./icon.svg?v=8.0","./holidays-om.json"];
